...
SELECT Property_Type, SUM(Total_Sales_Price), SUM(Number_Of_Sales) FROM MRE_Sale_FACT_L0 sf, MRE_Property_Dim_L0 p WHERE sf.property_id = p.property_id GROUP BY Property_Type ORDER BY Property_Type; -- 702,593,752 and 916  
